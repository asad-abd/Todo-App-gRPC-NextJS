...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListTodo = channel.unary_unary(
                ...
                request_serializer=todo__pb2.ListTodoRequest.SerializeToString,
                response_deserializer=todo__pb2.ListTodoResponse.FromString,
                )
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListTodo': grpc.unary_unary_rpc_method_handler(
                    servicer.ListTodo,
                    request_deserializer=todo__pb2.ListTodoRequest.FromString,
                    response_serializer=todo__pb2.ListTodoResponse.SerializeToString,
            ),
...
class TodoService(object):
    ...
    def ListTodo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TodoService/ListTodo',
            todo__pb2.ListTodoRequest.SerializeToString,
            todo__pb2.ListTodoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
